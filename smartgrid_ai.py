...
print(df[['Datetime','hour','day_of_week','month','is_weekend','is_night']].head())
...
plt.plot(results["Actual"][:100], label="Actual Demand", color="blue")
plt.plot(results["Predicted"][:100], linestyle="--", label="Predicted Demand", color="orange")
